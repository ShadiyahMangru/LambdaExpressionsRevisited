...
class HockeyPlayer{
	...
	public String toString(){
		return lastName + " | " + position + " | "+ pointsWins + " points";
	}
}

public class LambdaExpV3{ 
	//fields
	...
	public void setRoster(){
		...
		try{
			File file = new File("C:\\Users\\593476\\Desktop\\Java Programs\\roster2018PointsWins1_23_2019.txt"); 
			//File file = new File("C:\\Users\\593476\\Desktop\\Java Programs\\roster2018PointsWins1_22_2019.txt"); //another test file
			//File file = new File("C:\\Users\\593476\\Desktop\\Java Programs\\roster2018PointsWins.txt");  // a test file
	...
	public void setIntervals(){
		...
		float interval = (float)max/(float)4;
	...
	public static void main(String[] args) throws Exception{ 
    		LambdaExpV3 le = new LambdaExpV3();
    		le.pointsQuarters();
      } 
} 