...
class Roster{
	...
	public void setRoster(){
		...
		try{
			...
			File file = new File("C:\\Users\\593476\\Desktop\\Java Programs\\roster2018Goals_Shots_Stats2_14_2019.txt"); 
...
public class SupplierLambdas{
	...
	private static Supplier<String> assignTeam = () -> {
		return "WSH";
	};
	...
	private static void printSKShootPercent(HockeyPlayer hp){
		hp.setTeam(assignTeam.get()); //calls Supplier
		if(filterOutGoalies.test(hp)){ //calls Predicate
			...
			System.out.println(String.format("| %-4s | %-15s | %-15s |", s.getTeam(), s.getLastName() + "", "S%:  " + s.getShootingPercent()));
		}
	}
	...
	public static void main(String... args){
		...
		System.out.println("\n******* WSH Skaters' Shooting Percentage since 2/14/2019 *******\n");
		System.out.println(String.format("| %-4s | %-15s | %-15s |", "Team", "Player", "Shooting %"));
		System.out.println("---------------------------------------------");
